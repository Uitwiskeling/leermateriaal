...
% ONLY FOR # : "${XAKE_VERSION:=v2.7.xmcss-full}"    # with texlive_full
% \ifdefined\isXourse
...
%%% Begin Laad packages ALEXANDER ADDITIONS
\usepackage{amsmath}
% XCharter NIET hier laden: xmPrintstyle.sty laadt het al met opties (anders 'option clash')
%%%%%%%%%%%%%%%%%%%%%%
...
%% Uitgave-info: defaults hier (xmPreamble wordt voor pdf EN html geladen),
%% overschrijf per nummer in de xourse met \renewcommand*.
%% NIET in xmPrintstyle.sty zetten: dat wordt enkel voor pdf geladen, waardoor
%% de \renewcommand* in de xourse in de html-build op een ongedefinieerd commando botst.
\providecommand*{\uitgavenr}{}
\providecommand*{\uitgaveseizoen}{}
...
% TEMP : So not sure why Kwinten still left this here...
%%% ALEXANDERS COMMENTING OUT
% \usepackage{totcount}
