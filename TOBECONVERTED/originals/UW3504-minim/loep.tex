...
\eindewerktekst
\begin{center}
\includegraphics[width=0.75\linewidth]{tekeningenKurt/logsom.jpg}
\end{center}
\begin{multicols}{2}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width=\linewidth]{figurenAuteur/tabelstifel}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width=0.9\linewidth]{figurenAuteur/schonsp19}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width=0.90\linewidth]{figurenAuteur/schonsp15}
\end{center}
\end{figure}
\end{werktekstoef}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width=0.65\linewidth]{figurenAuteur/pythmetlog}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width=1\linewidth]{figurenAuteur/astronauten1}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width=1\linewidth]{figurenAuteur/geo}
...
\vspace{3cm}
\begin{center}
\includegraphics[width=1\linewidth]{tekeningenKurt/rekenlat.jpg}
\end{center}
\begin{multicols}{2}\newpage
\end{multicols}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width=0.55\linewidth]{figurenAuteur/startlogschaal}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width=0.95\linewidth]{figurenAuteur/logschalen}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width=0.65\linewidth]{figurenAuteur/tweemaaldrie}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width=0.85\linewidth]{figurenAuteur/dertiggedeelddoorvijf}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width=0.90\linewidth]{figurenAuteur/zesmaalvijftig}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width=0.75\linewidth]{figurenAuteur/driegedeelddoorvijf}
...
\includegraphics[width=\linewidth]{figurenAuteur/aristo1}
...
\includegraphics[width=\linewidth]{figurenAuteur/aristo2}
...
\includegraphics[width=\linewidth]{figurenAuteur/aristo3}
\captionof{figure}{$35,3\cdot 188$: cursorlijn op $3,53$ van de D-lijn en hierop de $1$ van de C-lijn verschuiven}
\label{aristo3}
\end{figure}

\begin{figure}[H]
\includegraphics[width=\linewidth]{figurenAuteur/aristo4}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width=0.45\linewidth]{figurenAuteur/decibelmeterapp}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width=0.90\linewidth]{figurenAuteur/puntbronlijnbron.jpg}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width=0.85\linewidth]{figurenAuteur/gehoordrempel.JPG}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width=0.90\linewidth]{figurenAuteur/dBtabel.png}
...
\begin{multicols}{2}
\begin{center}
\includegraphics[width=1\linewidth]{tekeningenKurt/richter.jpg}
\end{center}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width=0.6\linewidth]{figurenAuteur/gehoorverlies.JPG}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width=1\linewidth]{figurenAuteur/gehoorverliesbeiden.jpg}
\captionof{figure}{}
...
\end{multicols}
\begin{center}
\includegraphics[width=0.52\linewidth]{tekeningenKurt/koeienstank.jpg}
\end{center}
\begin{multicols}{2}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width=0.5\linewidth]{figurenAuteur/logschaal.JPG}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width=1\linewidth]{figurenAuteur/excelbenford.JPG}
