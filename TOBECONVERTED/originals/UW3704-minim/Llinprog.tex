...
\beginwerktekst{Fietsen en e-bikes}
	...
	\begin{center}
	\includegraphics[width=0.6\linewidth]{figurenAuteur/linprog1}
    \end{center}
	...
	\begin{center}
	    \includegraphics[width=0.6\linewidth]{figurenAuteur/linprog2}
	\end{center}
	...
	\begin{center}
	    \includegraphics[width=0.6\linewidth]{figurenAuteur/linprog3}
	\end{center}
...
\beginwerktekst{Nu helemaal zelf}
	...
	\begin{center}
	    \includegraphics[width=0.6\linewidth]{figurenAuteur/linprog4}
	\end{center}
	...
	\begin{center}
	    \includegraphics[width=0.55\linewidth]{figurenAuteur/linprog5}
	\end{center}	
    ...
    \end{kader}
	 \begin{center}
        \includegraphics[width=0.75\linewidth]{tekeningenKurt/UW 21 bus.jpg}
    \end{center}
    \begin{werktekstoef}
    ...
    \begin{center}
        \includegraphics[width=0.45\linewidth]{figurenAuteur/linprog6}
    \end{center}
...
\begin{multicols}{2}
    ...
    \begin{center}
        \includegraphics[width=0.45\linewidth]{figurenAuteur/linprog7}
    \end{center}
...
\eindewerktekst
  \begin{center}
        \includegraphics[width=1\linewidth]{tekeningenKurt/UW 21 pony.jpg}
    \end{center}   
\begin{multicols}{2}
...
\subsection{Lineaire programmering met een app}
    ...
    \begin{center}
    	\includegraphics[width=\linewidth]{figurenAuteur/linprog fig1.png}
    ...
    We maken in Excel een tabel met de koolhydraten, de eiwitten en de kostprijs per kg biks en hooi.
     ...
     \begin{center}
    	\includegraphics[width=1\linewidth]{figurenAuteur/linprog fig2.PNG} 
    ...
    Je voegt een rij met totalen toe. Je gaat onder de kolom van de koolhydraten staan, in de rij van de totalen, en je typt de Excelformule =x*D3+y*D4. Je kunt deze formule dan verslepen voor de andere kolommen (totale hoeveelheid eiwitten; totale prijs per kg). Voorlopig zijn de waarden 0 omdat $x$ en $y$ nog nul zijn.
     ...
     \begin{center}
    	\includegraphics[width=1\linewidth]{figurenAuteur/linprog fig3.PNG}
    ...
    \begin{center}
    	\includegraphics[width=\linewidth]{figurenAuteur/linprog fig4.PNG}
    ...
    \begin{center}
    	\includegraphics[width=1\linewidth]{figurenAuteur/linprog fig5.PNG}
...
\beginwerktekst{Meer dan één oplossing}
    ...
    \begin{center}
   	\includegraphics[width=0.63\linewidth]{figurenAuteur/linprog8.png}
   	\end{center}
...
\begin{multicols}{2}
    ...
    \begin{center}
    	\includegraphics[width=0.7\linewidth]{figurenAuteur/linprog fig6.PNG}
...
\begin{werktekstoef}
    ...
    \begin{center}
        \includegraphics[width=0.60\linewidth]{figurenAuteur/linprog3bis.png}
    \end{center} 
    ...
    \begin{center}
        \includegraphics[width=0.90\linewidth]{figurenAuteur/linprog3tris.png}
    \end{center} 
...
\beginwerktekst{Tarwetransport}
    ...
    \begin{center}
        \includegraphics[width=0.50\linewidth]{figurenAuteur/linprog9.png}
    \end{center}
    ...
    \begin{center}
        \includegraphics[width=0.5\linewidth]{figurenAuteur/linprog10.png}
    \end{center}
    ...
    \begin{center}
    	\includegraphics[width=0.70\linewidth]{figurenAuteur/linprog11.png}
    \end{center}
...
\beginwerktekst{Laptops verschepen}
    ...
    \begin{center}
        \includegraphics[width=0.45\linewidth]{figurenAuteur/linprog graaf.png}
    \end{center} 
    ...
    We zoeken het optimale punt met de schuifmethode
     ...
     \begin{center}
        \includegraphics[width=0.68\linewidth]{figurenAuteur/linprogparfig2.png}
    \end{center}
...
\subsection{Interpretatie in 3D van lineaire programmering met twee veranderlijken}
    ...
    \begin{center}
    	\includegraphics[width=\linewidth]{figurenAuteur/linprog fig7.png}
    ...
    \begin{center}
    	\includegraphics[width=\linewidth]{figurenAuteur/linprog fig8.PNG}
    ...
    \begin{center}
    	\includegraphics[width=\linewidth]{figurenAuteur/linprog fig9.png}
    ...
    \begin{center}
    	\includegraphics[width=\linewidth]{figurenAuteur/linprog fig10.png}
...
\beginwerktekst{Drie geneesmiddelen}
	...
	\begin{center}
		\includegraphics[width=0.4\linewidth]{figurenAuteur/linprog12.png}
	\end{center}
	...
	\begin{center}
		\includegraphics[width=0.65\linewidth]{figurenAuteur/linprog13.png}
		
	\end{center}
	
	
	\begin{center}
		\includegraphics[width=0.65\linewidth]{figurenAuteur/linprog14.png}
	\end{center}
...
\begin{multicols}{2}
		...
		\begin{center}
			\includegraphics[width=\linewidth]{figurenAuteur/linprog15.png}
			
			\includegraphics[width=\linewidth]{figurenAuteur/linprog16.png}
		\end{center}
...
\subsection{Wandelen langs de ribben}
	...
	\begin{center}
		\includegraphics[width=0.9\linewidth]{figurenAuteur/linprog fig11.PNG}
	...
	\begin{center}
		\includegraphics[width=1\linewidth]{tekeningenKurt/UW 21 berg.jpg}
	...
	\begin{center}
		\includegraphics[width=0.9\linewidth]{figurenAuteur/linprog fig12.png}
...
\beginwerktekst{Oefening}
	...
	\begin{center}
		\includegraphics[width=0.75\linewidth]{figurenAuteur/linprog17.png}
	\end{center}
...
\subsection{De simplexmethode}
	...
	\begin{center}
		\includegraphics[width=\linewidth]{figurenAuteur/linprog fig13.png}
