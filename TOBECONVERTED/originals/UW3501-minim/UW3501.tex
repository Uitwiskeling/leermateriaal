...
De oppervlakte van de driehoek $BMG$ is gelijk aan de oppervlakte van de driehoek $DMG$. Immers, als we $[MG]$ als basis kiezen, hebben ze dezelfde basis en dezelfde hoogte (linkse figuur). De oppervlakte van de driehoek $BMG$ is dus één twaalfde van de oppervlakte van de zeshoek.
 \begin{center}
  \includegraphics[width=5.5cm]{img/zeshoek02.jpg} \hspace{1cm} \includegraphics[width=5.5cm]{img/zeshoek03.jpg}
  \end{center}
...
\begin{center}
\includegraphics[width=2.9cm]{img/fig05} \hspace{0.2cm} \includegraphics[width=2.9cm]{img/fig03} \hspace{0.2cm} \includegraphics[width=2.9cm]{img/fig04} \hspace{0.2cm} \includegraphics[width=2.9cm]{img/fig02}\hspace{0.2cm} \includegraphics[width=2.9cm]{img/fig06}
\end{center}
