...
\begin{center}
\includegraphics[width=14cm]{figurenAuteur/gemiddeldesnelheid1.jpg}
%\captionof{figure}{}
\end{center}
...
\begin{center}
\includegraphics[width=14cm]{figurenAuteur/goudsmokkel.jpg}
\end{center}
\begin{flushright}
...
\begin{nummering}
  ...
  \item Bij de tweede opgave helpt het om een schets te maken. Om de plank in 3 stukken te zagen, moeten we twee keer zagen.
    \begin{center}
    \includegraphics[width=12cm]{figurenAuteur/plank1.jpg}
       \end{center} 
  
  Om de plank in 6 gelijke stukken te zagen moeten we 5 keer zagen.
  \begin{center}
    \includegraphics[width=12 cm]{figurenAuteur/plank2.jpg}
    \end{center}
\tabulinesep=1.5mm
    \begin{flushleft}
...
Bekijk de figuur hieronder. De rechten $a$ en $b$ zijn evenwijdig. Welk verband is er tussen de hoeken $\alpha$ en $\beta$ ?
  \begin{center}
  \includegraphics[width=0.4\linewidth]{figurenAuteur/hoeken.jpg}
  \end{center}
\eindewerktekst
...
Bepaal de verhouding van de oppervlakte van de driehoek $BMG$ tot de oppervlakte van de regelmatige zeshoek.
 \begin{center}
  \includegraphics[width=5.5cm]{figurenAuteur/zeshoek01.jpg}
  \end{center}
\eindewerktekst
...
De oppervlakte van de driehoek $BMG$ is gelijk aan de oppervlakte van de driehoek $DMG$. Immers, als we $[MG]$ als basis kiezen, hebben ze dezelfde basis en dezelfde hoogte (linkse figuur). De oppervlakte van de driehoek $BMG$ is dus één twaalfde van de oppervlakte van de zeshoek.
 \begin{center}
  \includegraphics[width=5.5cm]{figurenAuteur/zeshoek02.jpg} \hspace{1cm} \includegraphics[width=5.5cm]{figurenAuteur/zeshoek03.jpg}
  \end{center}
...
\begin{center}
\includegraphics[width=2.5cm]{figurenAuteur/vouw1a.png}\ \ 
\includegraphics[width=2.5cm]{figurenAuteur/vouw1b.png}
\end{center}
\end{werktekstoef}
...
\begin{center}
\includegraphics[width=7cm]{figurenAuteur/vouw2.png}
...
\vspace{4cm}
\begin{center}
\includegraphics[width=15cm]{tekeningenKurt/vouwlijn.jpg}
\end{center}
\tussentitel{Wat maakt deze oefening mooi?}
...
\begin{center}
\includegraphics[width=12cm]{figurenAuteur/lucifers01.jpg}
...
\begin{center}
\includegraphics[width=12cm]{figurenAuteur/lucifers02.jpg}
%\begin{tabular}{ m{3cm} m{3cm} m{3cm}  }
...
\begin{center}
\includegraphics[width=9cm]{figurenAuteur/joggers.jpg}
\end{center}
...
\tussentitel{Oplossing}
\begin{center}
    \includegraphics[width=11.7cm]{figurenAuteur/joggers2.jpg}
    %\captionof{figure}{\ }
\end{center}
...
\begin{center}
\includegraphics[width=\linewidth]{figurenAuteur/perspectief.jpg}
\end{center}
...
\begin{center}
    \includegraphics[width=14cm]{figurenAuteur/oplossing_tuinpad.jpg}
...
\tussentitel{Oplossing}
\begin{center}
    \includegraphics[width=9cm]{figurenAuteur/oplossing_bestelbusje.jpg}
...
\begin{nummering}
    ...
    \begin{center}
    \includegraphics[width=8cm]{figurenAuteur/oplossing_bestelbusje2.jpg}
     \end{center}
    %\captionof{figure}{}
...
\begin{center}
    \includegraphics[width=4.5cm]{figurenAuteur/kegel_kortste_pad.jpg}
\end{center}
...
\begin{center}
    \includegraphics[width=3cm]{figurenAuteur/kegel_kortste_pad2.jpg}\ \ 
    \includegraphics[width=5.75cm]{figurenAuteur/kegel_kortste_pad3.jpg}
...
\begin{center}
       \includegraphics[width=7cm]{figurenAuteur/kegel_kortste_pad4.jpg}
...
\begin{center}
       \includegraphics[width=9cm]{figurenAuteur/kegel_kortste_pad5.jpg}
...
\begin{center}
       \includegraphics[width=9cm]{figurenAuteur/kegel_kortste_pad6.jpg}
...
\begin{center}
\includegraphics[width=\linewidth]{figurenAuteur/sinus1.jpg}
%\captionof{figure}{}
\end{center}
...
\begin{center}
\includegraphics[width=\linewidth]{figurenAuteur/sinus2.png}
%\captionof{figure}{}
\end{center}
...
\begin{center}
\includegraphics[width=\linewidth]{figurenAuteur/sinus3.png}
%\captionof{figure}{}
\end{center}
...
\begin{center}
\includegraphics[width=\linewidth]{figurenAuteur/sinus4.png}
%\captionof{figure}{}
\end{center}
...
\begin{center}
\includegraphics[width=0.6\linewidth]{figurenAuteur/arcsin1.png}
%\captionof{figure}{}
\end{center}
...
\begin{center}
\includegraphics[width=6cm]{figurenAuteur/arcsin2.png}
%\captionof{figure}{}
\end{center}
...
\begin{center}
\includegraphics[width=10cm]{figurenAuteur/kussen1.png}
\end{center}
\eindewerktekst
\begin{center}
\includegraphics[width=8cm]{tekeningenKurt/kus.jpg}
\end{center}
...
\begin{center}
\includegraphics[width=0.49\linewidth]{figurenAuteur/kussen2bijgesnedenzw.png}\ 
\includegraphics[width=0.50\linewidth]{figurenAuteur/kussen3bijgesnedenzw.png}
...
\begin{center}
\includegraphics[width=3.5cm]{figurenAuteur/fig01}
\end{center}
Welk van de onderstaande grafieken geeft het verband tussen $x$ en $y$ weer? Omcirkel je antwoord en verklaar kort.\\
\begin{center}
\includegraphics[width=2.9cm]{figurenAuteur/fig05} \hspace{0.2cm} \includegraphics[width=2.9cm]{figurenAuteur/fig03} \hspace{0.2cm} \includegraphics[width=2.9cm]{figurenAuteur/fig04} \hspace{0.2cm} \includegraphics[width=2.9cm]{figurenAuteur/fig02}\hspace{0.2cm} \includegraphics[width=2.9cm]{figurenAuteur/fig06}
\end{center}
...
\begin{center}
    \includegraphics[width=6cm]{figurenAuteur/cosx=x.jpg}
    %\captionof{figure}{}
\end{center}
...
\begin{center}
    \includegraphics[width=6cm]{figurenAuteur/sinx=0,8.jpg}
    %\captionof{figure}{}
\end{center}
