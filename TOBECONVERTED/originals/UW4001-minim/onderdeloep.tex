...
\end{multicols} 
\afbeelding[14cm]{tekeningenKurt/UWjanuari24(Trump).jpg}{}{}
\begin{multicols}{2}
...
\columnbreak\begin{tabel}
		\begin{tabular}{m{2.8cm}r{2.8cm}} % tekstbreedte=15cm, elke tabelkolom = breedte + 2x2mm marge (2x want marge links & rechts)
			\hlinethick 
...
\end{multicols} 
\vspace{-3mm}
\afbeelding[11cm]{tekeningenKurt/UWjanuari24(zetelweg).jpg}{}{}
\vspace{-15mm}
\begin{multicols}{2}
...
\end{multicols} 
\vspace{-5mm}
\afbeelding[12.cm]{tekeningenKurt/UWjanuari24(zetelbij).jpg}{}{}
\vspace{-15mm}
\begin{multicols}{2}
