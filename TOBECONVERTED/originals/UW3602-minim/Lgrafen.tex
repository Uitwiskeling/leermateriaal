...
\begin{center}
	\includegraphics[width=0.8\linewidth]{figurenAuteur/plattegrond.jpg}
	\captionof{figure}{Plattegrond van een park}
	\label{plattegrond}
\end{center}

\begin{center}
	\includegraphics[width=0.85\linewidth]{figurenAuteur/elektrischeschakeling.jpg}
...
\begin{center}
	\includegraphics[width=0.8\linewidth]{figurenAuteur/graafabstract.jpg}
...
\begin{center}
	\includegraphics[width=\linewidth]{figurenAuteur/metro.jpg}
...
\begin{center}
	\includegraphics[width=\linewidth]{figurenAuteur/jakoetie.jpg}
...
\begin{center}
	\includegraphics[width=0.4\linewidth]{figurenAuteur/methaan.jpg}
...
\begin{center}
	\includegraphics[width=\linewidth]{figurenAuteur/isomeren.jpg}
...
\begin{center}
	\includegraphics[width=0.8\linewidth]{figurenAuteur/nutsvoorzieningen.jpg}
...
\begin{center}
	\includegraphics[width=0.4\linewidth]{figurenAuteur/nut1.jpg}
...
\begin{center}
	\includegraphics[width=0.4\linewidth]{figurenAuteur/nut2.jpg}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\linewidth]{tekeningenKurt/puzzelen.jpg}
\end{figure} 
...
\begin{center}
	\includegraphics[width=0.4\linewidth]{figurenAuteur/nut3.jpg}
...
\begin{center}
	\includegraphics[width=0.5\linewidth]{figurenAuteur/mok.jpg}
...
\begin{center}
	\includegraphics[width=0.7\linewidth]{figurenAuteur/printplaat.jpg}
...
\begin{center}
\includegraphics[width=0.65\linewidth]{figurenAuteur/grafen1.jpg}
...
\begin{center}
\includegraphics[width=0.22\linewidth]{figurenAuteur/grafengraden.jpg}
\end{center}
...
\begin{center}
\includegraphics[width=0.55\linewidth]{figurenAuteur/gradensom.JPG}
\end{center}
...
\begin{center}
\includegraphics[width=0.75\linewidth]{figurenAuteur/graafvoorbeeld.JPG}
\end{center}

\begin{center}
\includegraphics[width=0.65\linewidth]{figurenAuteur/graafvoorbeeld3.JPG}
\end{center}
...
\begin{center}
\includegraphics[width=0.35\linewidth]{figurenAuteur/graafvoorbeeld2.JPG}
\end{center}
...
\begin{center}
\includegraphics[width=\linewidth]{figurenAuteur/Ramsey1.JPG}

\includegraphics[width=\linewidth]{figurenAuteur/Ramsey2.JPG}

\includegraphics[width=\linewidth]{figurenAuteur/Ramsey3.JPG}
...
\begin{center}
\includegraphics[width=0.8\linewidth]{figurenAuteur/handen1.jpg}

\includegraphics[width=0.8\linewidth]{figurenAuteur/handen3.jpg}

\includegraphics[width=0.8\linewidth]{figurenAuteur/handen2.jpg}

\includegraphics[width=0.8\linewidth]{figurenAuteur/handen4.jpg}
...
\begin{center}
\includegraphics[width=0.8\linewidth]{figurenAuteur/voorbeeldpad.jpg}

\includegraphics[width=0.8\linewidth]{figurenAuteur/voorbeeldpad2.jpg}
\end{center}
...
\begin{center}
\includegraphics[width=0.35\linewidth]{figurenAuteur/brugbewijs.JPG}
...
\begin{center}
\includegraphics[width=0.25\linewidth]{figurenAuteur/tweedelingsgraaf.jpg}
...
\begin{center}
\includegraphics[width=0.25\linewidth]{figurenAuteur/tweedelingsgraaf10.jpg}
\end{center}
...
\includegraphics[width=0.9\linewidth]{figurenAuteur/tweedelingsgraaf3.jpg}


\includegraphics[width=0.8\linewidth]{figurenAuteur/tweedelingsgraaf4.jpg}

\includegraphics[width=0.8\linewidth]{figurenAuteur/tweedelingsgraaf5.jpg}
\end{center}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\linewidth]{tekeningenKurt/boom.jpg}
\end{figure} 
...
\begin{center}
\includegraphics[width=0.8\linewidth]{figurenAuteur/bomen.JPG}
\end{center}
...
\begin{center}
\includegraphics[width=0.45\linewidth]{figurenAuteur/bomen2.JPG}
\end{center}
...
\begin{center}
	\includegraphics[width=0.8\linewidth]{figurenAuteur/spelhamilton.jpg}
...
\begin{center}
	\includegraphics[width=0.45\linewidth]{figurenAuteur/dodecaeder.jpg}
	\captionof{figure}{Een hamiltoncykel op een dodecaëder}
	\label{dodecaëder}
\end{center}

\begin{center}
	\includegraphics[width=0.5\linewidth]{figurenAuteur/dodecaedergraaf.jpg}
...
\begin{center}
	\includegraphics[width=0.5\linewidth]{figurenAuteur/reisronddewereld.jpg}
\end{center}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\linewidth]{tekeningenKurt/citytrip.jpg}
\end{figure} 
\eindewerktekst
...
\begin{center}
	\includegraphics[width=0.35\linewidth]{figurenAuteur/paardensprong.jpg}
...
\begin{enumerate}
	...
	%\vspace{2cm}
	\begin{center}
		\includegraphics[width=0.8\linewidth]{figurenAuteur/paardenspronggraaf.jpg}
		%\captionof{figure}{De mogelijke eerste zetten van het paard}
	\end{center}
	\vspace{3cm}
	...
	\begin{center}
		\includegraphics[width=0.5\linewidth]{figurenAuteur/paardenspronggraafvolledig.jpg}
		%\captionof{figure}{De mogelijke eerste zetten van het paard}
	\end{center}
	...
	\begin{center}
		\includegraphics[width=0.5\linewidth]{figurenAuteur/paardenspronggraafvolledigplanair.jpg}
		%\captionof{figure}{De mogelijke eerste zetten van het paard}
	\end{center}
	...
	\begin{figure}[H]
\centering
\includegraphics[width=0.8\linewidth]{tekeningenKurt/knoop.jpg}
\end{figure} 
	...
	\begin{center}
		\includegraphics[width=0.3\linewidth]{figurenAuteur/paardenrondgangschaakbord4maal4.jpg}
		%\captionof{figure}{De mogelijke eerste zetten van het paard}
	\end{center}
	
	\emph{Nee, dit lukt niet.
	\begin{center}
		\includegraphics[width=0.27\linewidth]{figurenAuteur/paardenrondgangschaakbord4maal4opl.jpg}
		%\captionof{figure}{De mogelijke eerste zetten van het paard}
	\end{center}
	...
	%\begin{center}
	%	\includegraphics[width=0.4\linewidth]{figurenAuteur/paardenrondgangontwikkelingkubus.jpg}
		%\captionof{figure}{De mogelijke eerste zetten van het paard}
	%\end{center}
	...
	\begin{center}
		\includegraphics[width=0.4\linewidth]{figurenAuteur/paardenrondgang.jpg}\\
		\footnotesize{Bron: \url{https://www.archimedes-lab.org/knight_tour.html}}
	\end{center}
	
	\emph{Een oplossing: }
	\begin{center}
		\includegraphics[width=0.35\linewidth]{figurenAuteur/paardenrondgangopl.jpg} \includegraphics[width=0.35\linewidth]{figurenAuteur/paardenrondganggraaf.jpg}\\
...
\begin{center}
	\includegraphics[width=0.9\linewidth]{figurenAuteur/paardenrondgangschaakbord2.jpg}
...
\begin{enumerate}
	...
	\begin{center}
		\includegraphics[width=0.5\linewidth]{figurenAuteur/tweedelingsgraaf6.jpg}
	\end{center}
	...
	\begin{center}
		\includegraphics[width=0.5\linewidth]{figurenAuteur/tweedelingsgraaf7.jpg}
	\end{center}
	...
	\begin{center}
		\includegraphics[width=0.3\linewidth]{figurenAuteur/tweedelingsgraaf8.jpg}
	\end{center}
	...
	\emph{Als leerlingen er niet in slagen om zelf het antwoord op deze vraag te vinden, kun je hen de tip geven dat ze de vorige vraag kunnen gebruiken. \\Het is geen hamiltongraaf want het is een tweedelingsgraaf met een oneven aantal knopen. Uit de vorige vraag weten we dat deze niet hamiltoniaans kan zijn.}
		\begin{center}
		\includegraphics[width=0.3\linewidth]{figurenAuteur/tweedelingsgraaf9.jpg}
	\end{center}
...
\includegraphics[width=0.65\linewidth]{figurenAuteur/potlood1.jpg}
...
\begin{center}
\includegraphics[width=0.35\linewidth]{figurenAuteur/potlood3.jpg}
\end{center}
...
\begin{center}
\includegraphics[width=0.65\linewidth]{figurenAuteur/potlood2.jpg}
\end{center}
...
\begin{center}
\includegraphics[width=0.65\linewidth]{figurenAuteur/potlood5.jpg}
\end{center}
...
\begin{center}
\includegraphics[width=\linewidth]{figurenAuteur/Eulerbruggen.jpg}
...
\begin{center}
\includegraphics[width=0.6\linewidth]{figurenAuteur/Eulerbruggen2.JPG}
...
\begin{center}
\includegraphics[width=0.6\linewidth]{figurenAuteur/moord1.jpg}
\end{center}
...
\begin{center}
\includegraphics[width=0.4\linewidth]{figurenAuteur/stratenplan.JPG}
\end{center}
...
\begin{center}
\includegraphics[width=0.5\linewidth]{figurenAuteur/multigraafstratenplan.JPG}
...
\begin{center}
\includegraphics[width=0.55\linewidth]{figurenAuteur/potloodheffen1.JPG}
\end{center}
...
\begin{center}
\includegraphics[width=0.6\linewidth]{figurenAuteur/deelgraaf1.jpg}
\captionof{figure}{Een graaf $G$}
\label{boom1}
\includegraphics[width=0.7\linewidth]{figurenAuteur/deelgraaf6.jpg}
\captionof{figure}{Geen deelgraaf van $G$}
\label{boom2}
\includegraphics[width=0.6\linewidth]{figurenAuteur/deelgraaf7.jpg}
\captionof{figure}{Een deelgraaf van $G$}
\label{boom3}
\includegraphics[width=0.6\linewidth]{figurenAuteur/deelgraaf2.jpg}
...
\includegraphics[width=0.6\linewidth]{figurenAuteur/deelgraaf4.jpg}
\captionof{figure}{Een boom}
\label{boom5}
\includegraphics[width=0.6\linewidth]{figurenAuteur/deelgraaf8.JPG}
\captionof{figure}{Geen boom}
\label{boom6}
\includegraphics[width=0.6\linewidth]{figurenAuteur/deelgraaf3.jpg}
...
\begin{center}
\includegraphics[width=0.70\linewidth]{figurenAuteur/steden.jpg}
\end{center}
...
\begin{center}
\includegraphics[width=0.70\linewidth]{figurenAuteur/steden2.jpg}
\end{center}
...
\begin{center}
\includegraphics[width=0.70\linewidth]{figurenAuteur/stedenprim4.jpg}
\end{center}
...
\begin{center}
\includegraphics[width=0.75\linewidth]{figurenAuteur/Engelsesteden.JPG}
\end{center}
...
\begin{center}
\includegraphics[width=0.60\linewidth]{figurenAuteur/Engelsestedenopl.JPG}
\end{center}
...
\begin{multicols}{2}
\begin{center}
\includegraphics[width=\linewidth]{figurenAuteur/stedenstap1.JPG}

\includegraphics[width=\linewidth]{figurenAuteur/stedenprim2.JPG}

\includegraphics[width=\linewidth]{figurenAuteur/stedenprim3.JPG}

\includegraphics[width=\linewidth]{figurenAuteur/stedenprim4.JPG}
\end{center}
...
\includegraphics[width=\linewidth]{figurenAuteur/stedenkruskal3.JPG}

\includegraphics[width=\linewidth]{figurenAuteur/stedenkruskal2.JPG}

\includegraphics[width=\linewidth]{figurenAuteur/stedenopl.JPG}
