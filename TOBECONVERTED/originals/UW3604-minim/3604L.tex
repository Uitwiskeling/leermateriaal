...
\begin{figure}[h]
\begin{center}
\includegraphics[width=0.8\linewidth]{figurenAuteur/graaf1.PNG}
...
\begin{figure}[h]
\begin{center}
\includegraphics[width=0.8\linewidth]{figurenAuteur/graaf2.PNG}
...
\begin{figure}[h]
\begin{center}
\includegraphics[width=0.8\linewidth]{figurenAuteur/graaf3.PNG}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width=8cm]{tekeningenKurt/pinocchio.jpg}
\end{center}
\end{figure}
\vspace{-1cm}
...
\begin{center}
\includegraphics[width=0.7\linewidth]{figurenAuteur/driegrafieken.jpg}
...
\begin{center}
\includegraphics[width=0.8\linewidth]{figurenAuteur/flattenthecurve.jpg}
...
\linewidth]{figurenAuteur/oppervlakte1.jpg}
\captionof{figure}{Impact van een ziekte met een dalend infectieverloop}
\label{opp1}
\end{center}

\begin{center}
\includegraphics[width=0.65\linewidth]{figurenAuteur/oppervlakte2.jpg}
...
\begin{center}
\includegraphics[width=0.6\linewidth]{figurenAuteur/impact1.jpg}
...
\begin{center}
\includegraphics[width=0.6\linewidth]{figurenAuteur/impact2.jpg}
...
\begin{center}
\includegraphics[width=0.6\linewidth]{figurenAuteur/impact3.jpg}
...
\begin{center}
\includegraphics[width=0.8\linewidth]{figurenAuteur/retrograde.jpg}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width=14cm]{tekeningenKurt/reproductiegetal.jpg}
\end{center}
\end{figure}
