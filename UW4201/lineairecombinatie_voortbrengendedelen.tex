...
Is het mogelijk oom Gauss te bezoeken met je twee vervoersmiddelen?
\begin{multipleChoice}  
\choice[correct]{Ja}  
\choice{Nee}
\end{multipleChoice}
Geef een gedetailleerde verklaring waarom wel of waarom niet; met een diagram, en gebruik gepaste vectornotatie om je redenering te ondersteunen.
\begin{hint}
...
\begin{image}
    % In tikz-nodes geen pmatrix gebruiken (breekt de HTML/SVG-build); wel \left(\begin{smallmatrix}...\end{smallmatrix}\right)
    ...
    \draw[->, thick, orange!70] (0,0) -- (6,2) node[midway, below, sloped, black] {$\color{orange}2\left(\begin{smallmatrix} 3 \\ 1 \end{smallmatrix}\right)$};
    \draw[->, thick, purple!70] (0,0) -- (3,6) node[midway, above, sloped, black] {$\color{purple}3\left(\begin{smallmatrix} 1 \\ 2 \end{smallmatrix}\right)$};

    % basisvectoren hoverboard en tapijt
    \draw[->, thick, red!70] (0,0) -- (3,1) node[midway, below, sloped, black] {$\color{red}\left(\begin{smallmatrix} 3 \\ 1 \end{smallmatrix}\right)$};
    \draw[->, thick, blue!70] (0,0) -- (1,2) node[midway, above, sloped, black] {$\color{blue}\left(\begin{smallmatrix} 1 \\ 2 \end{smallmatrix}\right)$};
    
    % Resultant vector
    \draw[->, ultra thick,] (0,0) -- (9,8) node[midway, above, rotate=45, black] {$2 \left(\begin{smallmatrix} 3 \\ 1 \end{smallmatrix}\right) + 3 \left(\begin{smallmatrix} 1 \\ 2 \end{smallmatrix}\right)$};
...
\end{image}
\captionof{figure}{Een voorbeeld van een lineaire combinatie van de hoverboard- en tapijtrichtingen.}
